          ...
          <div class="row">
            <div class="col-lg-5">
              <div class="mb-5 mt-11">
                <h1 class="display-4 mb-3"> Intercambio De Monedas</h1>
<p class="lead">Nuestra plataforma de intercambio de monedasdigitales y descentralizadas
  en funciones le brinda todas las herramientas que necesita
   para intercambiar criptomonedas de manera eficiente y segura</p></div>

              <a class="btn btn-primary btn-wide transition-3d-hover" href="">Empezar</a>
              <a class="btn btn-link btn-wide" href="#">Aprende más<i class="fas fa-angle-right fa-sm ml-1"></i></a>
            </div>
          </div>
        </div>
        <!-- End Content -->
        ...
        <figure class="col-lg-7 col-xl-6 d-none d-lg-block position-absolute top-0 right-0 pr-0 ie-main-hero" style="margin-top: 6.75rem;">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1137.5 979.2">
            ...
            <g transform="matrix(1 0 0 1 0 0)" clip-path="url(#mainHeroSVG2)">
              <image width="750" height="750" xlink:href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToEyk0O-EWPWLvcrKtxMGBida6pb6IeZQf0w&usqp=CAU" transform="matrix(1.4462 0 0 1.4448 52.8755 0)"></image>
            </g>
          </svg>
        </figure>
